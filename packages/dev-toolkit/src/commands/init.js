...
import { generatedExamples, generatedExamplesWithoutComments, defaultExample } from '../webpack/projectSettings';
...
if (example && !exampleExists) {
  ...
  log({ message: '\nProject will be initialized using default example files.', useSeparator: true });
}
